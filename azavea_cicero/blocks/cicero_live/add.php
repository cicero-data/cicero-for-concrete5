<p>Please enter your Cicero username and password, and your Bing Maps API key.</p>
<?php echo $form->label('user_name', 'User Name');?>
<?php echo $form->text('user_name', $user_name, array('style' => 'width: 320px'));?>
<?php echo $form->label('password', 'Password');?>
<?php echo $form->password('password', $password!==null?$password:'', array('style' => 'width: 320px'));?>
